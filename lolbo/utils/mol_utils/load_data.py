...
def load_molecule_train_data(
    ...
    df = pd.read_csv("/sandbox/vkolluru/Gen_models_for_FANTASTX/May2023/1_LOLBO/github_repo/lolbo/lolbo/utils/mol_utils/guacamol_data/guacamol_train_data_first_20k.csv")
