...
print (7)
valt = None #standard_benchmarks.valsartan_smarts()  #'Valsartan SMARTS',
print (8)
dhop = None #standard_benchmarks.decoration_hop() # 'Deco Hop'
print (9)
shop = None #standard_benchmarks.scaffold_hop() # Scaffold Hop'
print (10)
rano= None #standard_benchmarks.ranolazine_mpo() #'Ranolazine MPO' 
print (11)
fexo = None #standard_benchmarks.hard_fexofenadine() # 'Fexofenadine MPO'... 'make fexofenadine less greasy'
print (12)
